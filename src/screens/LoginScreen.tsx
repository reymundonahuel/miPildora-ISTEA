  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      if (!userGuardado) {
        Alert.alert(
          "Error",
          "No hay ningun usuario registrado. Creá uno primero.",
        );
        return;
      }

      if (
        userGuardado.username === usuario.trim() &&
        userGuardado.password === pass.trim()
      ) {
        // login ok
    ...
    >
      <ScrollView contentContainerStyle={styles.container}>
        ...
        <View style={styles.form}>
          ...
          <Boton
            titulo={cargando ? "Entrando..." : "Iniciar Sesión"}
            onPress={handleLogin}
          />
